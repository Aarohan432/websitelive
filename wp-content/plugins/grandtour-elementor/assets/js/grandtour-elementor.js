...
( function( $ ) {
	...
	$( window ).on( 'elementor/frontend/init', function() {
		...
		jQuery('.grandtour-cart-mini-cart-link').on( 'click', function(){
		...
		jQuery("img.lazy").each(function() {
			...
			jQuery(this).Lazy({
				onFinishedAll: function() {
					...
					currentImg.parent('.grandtour_gallery_lightbox').parent("div.gallery-grid-item").removeClass("lazy");
		        }
			});
		});
		...
		elementorFrontend.hooks.addAction('frontend/element_ready/global', function( $scope ) {
			...
			if(typeof widgetExt != 'undefined')
			{
					...
					if(typeof widgetExt.background_background != 'undefined' && widgetExt.background_background == 'classic')
					{
						...
						if(!elementorFrontend.isEditMode())
						{
							...
							if(widgetBg != '')
							{
								...
								if(typeof widgetExt.grandtour_ext_is_background_parallax_speed.size != 'undefined')
								{
				...
				{
					var scrollVelocity = parseFloat(widgetExt.grandtour_ext_is_fadeout_animation_velocity.size);
					var scrollDirection = widgetExt.grandtour_ext_is_fadeout_animation_direction; 
				...
				{	
					...
					if(typeof widgetExt.grandtour_ext_scrollme_scalex.size != 'undefined' && widgetExt.grandtour_ext_scrollme_scalex.size != 1)
					{
					...
					if(typeof widgetExt.grandtour_ext_scrollme_disable != 'undefined')
					{
				...
				{				
					...
					$scope.smoove({
						min_width : parseInt(widgetExt.grandtour_ext_smoove_disable),
						
						scaleX   : widgetExt.grandtour_ext_smoove_scalex.size,
					    scaleY   : widgetExt.grandtour_ext_smoove_scaley.size,
					    
					    rotateX   : parseInt(widgetExt.grandtour_ext_smoove_rotatex.size)+'deg',
					    rotateY   : parseInt(widgetExt.grandtour_ext_smoove_rotatey.size)+'deg',
					    rotateZ   : parseInt(widgetExt.grandtour_ext_smoove_rotatez.size)+'deg',
					    
					    moveX   : parseInt(widgetExt.grandtour_ext_smoove_translatex.size)+'px',
					    moveY   : parseInt(widgetExt.grandtour_ext_smoove_translatey.size)+'px',
					    moveZ   : parseInt(widgetExt.grandtour_ext_smoove_translatez.size)+'px',
					    
					    skewX   : parseInt(widgetExt.grandtour_ext_smoove_skewx.size)+'deg',
					    skewY   : parseInt(widgetExt.grandtour_ext_smoove_skewy.size)+'deg',
					    
					    perspective :  parseInt(widgetExt.grandtour_ext_smoove_perspective.size),
						transformOrigin :  parseInt(widgetExt.grandtour_ext_smoove_transform_originy.size)+'% '+parseInt(widgetExt.grandtour_ext_smoove_transform_originx.size)+'%',
					    
					    offset : '-5%',
					});
		
					if(typeof widgetExt.grandtour_ext_smoove_duration != 'undefined')
					{
						$scope.css('transition-duration', parseInt(widgetExt.grandtour_ext_smoove_duration)+'ms');
					}
					
					var width = jQuery(window).width();
					if (widgetExt.grandtour_ext_smoove_disable >= width) {
				...
				{	
					...
					$scope.find('.elementor-widget-container').attr('data-depth', parseFloat(widgetExt.grandtour_ext_is_parallax_mouse_depth.size));
				...
				if(typeof widgetExt.grandtour_ext_is_infinite != 'undefined' && widgetExt.grandtour_ext_is_infinite == 'true')
				{
					...
					if(typeof widgetExt.grandtour_ext_infinite_animation != 'undefined')
					{
						animationClass = widgetExt.grandtour_ext_infinite_animation;
					...
					//alert(widgetExt.grandtour_ext_infinite_duration);
					...
					if(typeof widgetExt.grandtour_ext_infinite_easing != 'undefined')
					{
				...
				if(typeof widgetExt.grandtour_ext_is_sticky != 'undefined' && widgetExt.grandtour_ext_is_sticky == 'true')
				{
					...
					var topSpacing = 100;
					if(typeof widgetExt.grandtour_ext_sticky_top_spacing != 'undefined')
					{
					...
					jQuery(window).on("scroll touchmove", function() {
						...
						if (scroll > position) { 
							...
							if (jQuery(document).scrollTop() >= elementTop && jQuery(document).scrollTop() <= elementBottom) {
								//jQuery('body').css('background-color', widgetExt.grandtour_ext_background_on_scroll_color);
								jQuery('#wrapper').css('background-color', widgetExt.grandtour_ext_background_on_scroll_color);
							}
							...
							if (jQuery(document).scrollTop() <= elementBottom && jQuery(document).scrollTop() >= elementTop) {
								...
								$.data(this, 'scrollTimer2', setTimeout(function() {
									jQuery('#wrapper').css('background-color', widgetExt.grandtour_ext_background_on_scroll_color).stop();
								}, 250));
								
								/*setTimeout(function(){
									//jQuery('body').css('background-color', widgetExt.grandtour_ext_background_on_scroll_color).stop();
									jQuery('#wrapper').css('background-color', widgetExt.grandtour_ext_background_on_scroll_color).stop();
								}, 100);*/
							}
		...
		elementorFrontend.hooks.addAction( 'frontend/element_ready/grandtour-blog-posts.default', function( $scope ) {
			jQuery(function( $ ) {
				jQuery("img.lazy").each(function() {
					var currentImg = jQuery(this);
		...
		elementorFrontend.hooks.addAction( 'frontend/element_ready/grandtour-gallery-grid.default', function( $scope ) {
			jQuery("img.lazy").each(function() {
				var currentImg = jQuery(this);
		...
		elementorFrontend.hooks.addAction( 'frontend/element_ready/grandtour-gallery-masonry.default', function( $scope ) {
			jQuery(function( $ ) {
				jQuery(".grandtour-gallery-grid-content-wrapper.do-masonry:not(.proofing-gallery)").each(function() {
					var grid = jQuery(this);
					...
					grid.imagesLoaded(function() {
						...
						jQuery(".grandtour-gallery-grid-content-wrapper.do-masonry .gallery-grid-item").each(function(index) {
						    setTimeout(function() {
					...
					jQuery(".grandtour-gallery-grid-content-wrapper.do-masonry img.lazy_masonry").each(function() {
						var currentImg = jQuery(this);
						currentImg.parent("div.post-featured-image-hover").removeClass("lazy");
		...
		//Start execute javascript for gallery masonry
		elementorFrontend.hooks.addAction( 'frontend/element_ready/grandtour-gallery-proofing.default', function( $scope ) {
			jQuery(function( $ ) {
				jQuery(".grandtour-gallery-grid-content-wrapper.do-masonry.proofing-gallery").each(function() {
					var grid = jQuery(this);
					var cols = grid.attr('data-cols');
					...
					grid.find('.gallery-grid-approve').on('click', function(){
						...
						if(jQuery('#gallery_proofing_status').val() == 0)
						{
							jQuery.ajax({
								url: tgAjax.ajaxurl,
								type:'POST',
								data: 'action=grandtour_image_proofing&method=approve&gallery_id='+galleryID+'&image_id='+imgID+'&themegoods_security='+WPonce, 
					...
					grid.find('.gallery-grid-unapprove').on('click', function(){
						...
						if(jQuery('#gallery_proofing_status').val() == 0)
						{
							jQuery.ajax({
								url: tgAjax.ajaxurl,
								type:'POST',
								data: 'action=grandtour_image_proofing&method=unapprove&gallery_id='+galleryID+'&image_id='+imgID+'&themegoods_security='+WPonce, 
								error: function (xhr, ajaxOptions, thrownError) {
									console.log(thrownError);
								},
								success:function(results) {
		...
		elementorFrontend.hooks.addAction( 'frontend/element_ready/grandtour-gallery-justified.default', function( $scope ) {
			jQuery(function( $ ) {
				jQuery("img.lazy").each(function() {
					var currentImg = jQuery(this);
				...
				jQuery(".grandtour-gallery-grid-content-wrapper.do-justified").each(function() {
					var grid = jQuery(this);
		...
		elementorFrontend.hooks.addAction( 'frontend/element_ready/grandtour-gallery-fullscreen.default', function( $scope ) {
			jQuery(function( $ ) {
		...
		elementorFrontend.hooks.addAction( 'frontend/element_ready/grandtour-slider-vertical-parallax.default', function( $scope ) {
			jQuery(function( $ ) {
		...
		elementorFrontend.hooks.addAction( 'frontend/element_ready/grandtour-gallery-horizontal.default', function( $scope ) {
		...
		elementorFrontend.hooks.addAction( 'frontend/element_ready/grandtour-slider-horizontal.default', function( $scope ) {
		...
		elementorFrontend.hooks.addAction( 'frontend/element_ready/grandtour-slider-animated-frame.default', function( $scope ) {
		...
		elementorFrontend.hooks.addAction( 'frontend/element_ready/grandtour-slider-room.default', function( $scope ) {
			jQuery('body').addClass('elementor-fullscreen');
		...
		elementorFrontend.hooks.addAction( 'frontend/element_ready/grandtour-slider-multi-layouts.default', function( $scope ) {
		...
		elementorFrontend.hooks.addAction( 'frontend/element_ready/grandtour-slider-velo.default', function( $scope ) {
			jQuery('body').addClass('elementor-fullscreen');
		...
		elementorFrontend.hooks.addAction( 'frontend/element_ready/grandtour-slider-popout.default', function( $scope ) {
			jQuery('body').addClass('elementor-fullscreen');
		...
		elementorFrontend.hooks.addAction( 'frontend/element_ready/grandtour-slider-clip-path.default', function( $scope ) {
			jQuery('body').addClass('elementor-fullscreen');
		...
		elementorFrontend.hooks.addAction( 'frontend/element_ready/grandtour-gallery-preview.default', function( $scope ) {
			jQuery('body').addClass('grandtour-gallery-preview');
		...
		elementorFrontend.hooks.addAction( 'frontend/element_ready/grandtour-slider-split-slick.default', function( $scope ) {
			jQuery('body').addClass('elementor-fullscreen');
		...
		elementorFrontend.hooks.addAction( 'frontend/element_ready/grandtour-slider-transitions.default', function( $scope ) {
			jQuery('body').addClass('elementor-fullscreen');
		...
		elementorFrontend.hooks.addAction( 'frontend/element_ready/grandtour-slider-property-clip.default', function( $scope ) {
		...
		elementorFrontend.hooks.addAction( 'frontend/element_ready/grandtour-slider-slice.default', function( $scope ) {
		...
		elementorFrontend.hooks.addAction( 'frontend/element_ready/grandtour-slider-flip.default', function( $scope ) {
			//jQuery('body').addClass('elementor-fullscreen');
		...
		elementorFrontend.hooks.addAction( 'frontend/element_ready/grandtour-slider-split-carousel.default', function( $scope ) {
		...
		elementorFrontend.hooks.addAction( 'frontend/element_ready/grandtour-horizontal-timeline.default', function( $scope ) {
		...
		*/
		...
		elementorFrontend.hooks.addAction( 'frontend/element_ready/grandtour-background-list.default', function( $scope ) {
		...
		elementorFrontend.hooks.addAction( 'frontend/element_ready/grandtour-portfolio-masonry.default', function( $scope ) {
			jQuery(function( $ ) {
		...
		elementorFrontend.hooks.addAction( 'frontend/element_ready/grandtour-portfolio-masonry-grid.default', function( $scope ) {
			jQuery(function( $ ) {
		...
		elementorFrontend.hooks.addAction( 'frontend/element_ready/grandtour-portfolio-timeline.default', function( $scope ) {
			var timelines = jQuery('.cd-horizontal-timeline');
			var eventsMinDistance = timelines.attr('data-spacing');
		...
		*/
		...
		//Start execute javascript for background list
		elementorFrontend.hooks.addAction( 'frontend/element_ready/grandtour-portfolio-timeline-vertical.default', function( $scope ) {
		...
		elementorFrontend.hooks.addAction( 'frontend/element_ready/grandtour-slider-parallax.default', function( $scope ) {
		...
		elementorFrontend.hooks.addAction( 'frontend/element_ready/grandtour-distortion-grid.default', function( $scope ) {
		...
		elementorFrontend.hooks.addAction( 'frontend/element_ready/grandtour-slider-animated.default', function( $scope ) {
		...
		elementorFrontend.hooks.addAction( 'frontend/element_ready/grandtour-slider-fadeup.default', function( $scope ) {
			function init(item) {
		...
		elementorFrontend.hooks.addAction( 'frontend/element_ready/grandtour-slider-motion-reveal.default', function( $scope ) {
			// The Slide class.
		    class Slide {
		        constructor(el) {
					this.DOM = {el: el};
		...
		elementorFrontend.hooks.addAction( 'frontend/element_ready/grandtour-testimonial-card.default', function( $scope ) {
		...
		elementorFrontend.hooks.addAction( 'frontend/element_ready/grandtour-testimonial-slider.default', function( $scope ) {
		...
		elementorFrontend.hooks.addAction( 'frontend/element_ready/grandtour-slider-image-carousel.default', function( $scope ) {
		...
		elementorFrontend.hooks.addAction( 'frontend/element_ready/grandtour-portfolio-grid.default', function( $scope ) {
		...
		elementorFrontend.hooks.addAction( 'frontend/element_ready/grandtour-portfolio-grid-overlay.default', function( $scope ) {
		...
		elementorFrontend.hooks.addAction( 'frontend/element_ready/grandtour-portfolio-3d-overlay.default', function( $scope ) {
			jQuery(".portfolio-grid-overlay-container").each(function() {
				var containderDiv = jQuery(this);
				var selectedClass = "";
		...
		elementorFrontend.hooks.addAction( 'frontend/element_ready/grandtour-portfolio-classic.default', function( $scope ) {
		...
		elementorFrontend.hooks.addAction( 'frontend/element_ready/grandtour-portfolio-contain.default', function( $scope ) {
		...
		elementorFrontend.hooks.addAction( 'frontend/element_ready/grandtour-navigation-menu.default', function( $scope ) {
		...
		elementorFrontend.hooks.addAction( 'frontend/element_ready/grandtour-video-grid.default', function( $scope ) {
		...
		elementorFrontend.hooks.addAction( 'frontend/element_ready/grandtour-portfolio-coverflow.default', function( $scope ) {
		...
		elementorFrontend.hooks.addAction( 'frontend/element_ready/grandtour-glitch-slideshow.default', function( $scope ) {
			class Slide {
		        constructor(el) {
		            this.DOM = {el: el};
		...
		elementorFrontend.hooks.addAction( 'frontend/element_ready/grandtour-music-player.default', function( $scope ) {
			jQuery(".grandtour-music-player").each(function() {
				var containerDiv = jQuery(this);
		...
		elementorFrontend.hooks.addAction( 'frontend/element_ready/grandtour-mouse-driven-vertical-carousel.default', function( $scope ) {
		...
		elementorFrontend.hooks.addAction( 'frontend/element_ready/grandtour-slider-synchronized-carousel.default', function( $scope ) {
		...
		elementorFrontend.hooks.addAction( 'frontend/element_ready/grandtour-flip-box.default', function( $scope ) {
		...
		elementorFrontend.hooks.addAction( 'frontend/element_ready/grandtour-slider-zoom.default', function( $scope ) {
			var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
		...
		elementorFrontend.hooks.addAction( 'frontend/element_ready/grandtour-course-grid.default', function( $scope ) {
		...
		elementorFrontend.hooks.addAction( 'frontend/element_ready/grandtour-search.default', function( $scope ) {
			
			jQuery(".grandtour-search-icon").each(function() {
				...
				iconInput.bind('click', function () {
				    ...
				    var isTouch = ('ontouchstart' in document.documentElement);
					if ( isTouch ) {
				    	jQuery('#'+openDiv).find('.grandtour-search-inner').addClass('touch');
				    }
					...
					formInput.on('input', function() {
						if(jQuery(this).val().length > 1)
						{
							jQuery.ajax({
								url: tgAjax.ajaxurl,
								type:'POST',
								data:'action=grandtour_ajax_search_result&'+jQuery(this).serialize(),
								success:function(results) {
		...
		elementorFrontend.hooks.addAction( 'frontend/element_ready/image.default', function( $scope ) {
			...
			if(typeof widgetExt != 'undefined')
			{
				...
				{
					$scope.addClass('themegoods-image-animation-'+widgetExt.grandtour_image_animation_effect);
		...
		elementorFrontend.hooks.addAction( 'frontend/element_ready/grandtour-portfolio-carousel.default', function( $scope ) {
		...
		elementorFrontend.hooks.addAction( 'frontend/element_ready/grandtour-service-grid.default', function( $scope ) {
		...
		elementorFrontend.hooks.addAction( 'frontend/element_ready/grandtour-service-carousel.default', function( $scope ) {
		...
		elementorFrontend.hooks.addAction( 'frontend/element_ready/grandtour-blog-carousel.default', function( $scope ) {
		...
		elementorFrontend.hooks.addAction( 'frontend/element_ready/grandtour-tour-carousel.default', function( $scope ) {
			jQuery(".tour-carousel-wrapper .owl-carousel").each(function() {
				var autoPlay = jQuery(this).attr('data-autoplay');
				if (typeof autoPlay == "undefined"){
					autoPlay = false;
				}
		...
		elementorFrontend.hooks.addAction( 'frontend/element_ready/grandtour-pricing-table.default', function( $scope ) {
		...
		elementorFrontend.hooks.addAction( 'frontend/element_ready/grandtour-food-menu.default', function( $scope ) {
		...
		elementorFrontend.hooks.addAction( 'frontend/element_ready/grandtour-search-form.default', function( $scope ) {
				...
				formInput.on('input', function() {
					if(jQuery(this).val().length > 1)
					{
						jQuery.ajax({
							url: tgAjax.ajaxurl,
							type:'POST',
							data:'action=grandtour_ajax_search_result&search_event='+eventOnly+'&'+jQuery(this).serialize(),
							success:function(results) {
								jQuery("#"+resultDiv).html(results);
		...
		elementorFrontend.hooks.addAction( 'frontend/element_ready/grandtour-animated-headline.default', function( $scope ) {
		...
		elementorFrontend.hooks.addAction( 'frontend/element_ready/grandtour-animated-text.default', function( $scope ) {
		...
		elementorFrontend.hooks.addAction( 'frontend/element_ready/grandtour-gallery-animated.default', function( $scope ) {
			jQuery(".grandtour-gallery-animated-content-wrapper").each(function() {
		...
		elementorFrontend.hooks.addAction( 'frontend/element_ready/grandtour-team-carousel.default', function( $scope ) {
		...
		elementorFrontend.hooks.addAction( 'frontend/element_ready/grandtour-classic-tour-search.default', function( $scope ) {
		...
		//Start execute javascript for session fullwidth
		elementorFrontend.hooks.addAction( 'frontend/element_ready/grandtour-classic-session-sidebar.default', function( $scope ) {
		...
		elementorFrontend.hooks.addAction( 'frontend/element_ready/grandtour-classic-session-tab.default', function( $scope ) {
		...
		//Start execute javascript for testimonials slider
		elementorFrontend.hooks.addAction( 'frontend/element_ready/grandtour-classic-testimonials-slider.default', function( $scope ) {
		...
		elementorFrontend.hooks.addAction( 'frontend/element_ready/grandtour-countdown.default', function( $scope ) {
		...
		elementorFrontend.hooks.addAction( 'frontend/element_ready/grandtour-background-menu-effect.default', function( $scope ) {
